...
<html>
<head>
<link href="resources/css/7_ETC.css?ver=1" type="text/css" rel="stylesheet">
...
<script type="text/javascript">
	$(function() {
		$("#out-Notice").load("notice.do");
		$("#out-Board").load("freeboard2.do");
		...
		$("#goFree").click(function() {
			$("#out-Board").empty();
			$("#out-Notice").load("freeboard.do");
		});
		$("#goQA").click(function() {
			$("#out-Board").empty();
			$("#out-Notice").load("QnA.do");
		});
	});
</script>
</head>
		...
		<div id="main-container">
			...
			<div id="sub-title">
				<div class="title-area">
					<h3 class="sub-title-color">게시판</h3>
				</div>
